        ...
        <div class="login-form-section">
            <div class="login-card">
                ...
                <div class="login-body">
                    ...
                    <form method="POST" action="index.php?action=register" class="login-form">
                        <div class="form-row">
                        ...
                        <div class="form-group">
                            <div class="input-wrapper">
                                ...
                                <input type="password" class="form-input" name="confirm_password"
                                    ...
                                    required>
                                <button type="button" class="password-toggle confirm-toggle">
                                    <i class="fas fa-eye"></i>
                                </button>
                            </div>
                        </div>
...
<style>
    /* ========================================================================== 
   REGISTER STYLES - CONSISTENT WITH LOGIN
   ========================================================================== */
    .login-container {
        min-height: 80vh;
        display: flex;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (passwordInput) {
            passwordInput.addEventListener('input', function() {
                const requirements = this.closest('.form-group').querySelector('.password-requirements');
                if (this.value.length >= 6) {
                    requirements.innerHTML = '<i class="fas fa-check" style="color: var(--success)"></i> Mot de passe valide';
                } else {
                    requirements.innerHTML = '<i class="fas fa-info-circle"></i> Minimum 6 caractères';
                }
            });
        }
